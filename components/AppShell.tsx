  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f0e7] text-[#211b16]">
      ...
      <div className="relative z-10 flex min-h-screen p-4 lg:p-6 gap-6">
        <aside className="hidden lg:flex w-[310px] shrink-0 rounded-[2.2rem] border border-white/60 bg-[#171411]/95 text-white shadow-[0_30px_100px_rgba(20,14,8,0.35)] backdrop-blur-2xl flex-col overflow-hidden">
        ...
        <section className="flex-1 overflow-auto rounded-[2.2rem] border border-white/70 bg-white/45 shadow-[0_30px_100px_rgba(118,93,60,0.14)] backdrop-blur-2xl">
          <header className="sticky top-0 z-20 border-b border-white/70 bg-white/55 backdrop-blur-2xl px-6 lg:px-10 py-6">
