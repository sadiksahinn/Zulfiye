...
const templates = [
  {
    ...
    message:
      "Merhaba {musteri}, MAUNA Couture prova randevunuz için sizi bekliyoruz.",
  },
  {
    title: "Teslim Hazır",
    message:
      "Merhaba {musteri}, ürününüz teslim için hazırdır. Detaylı bilgi için bizimle iletişime geçebilirsiniz.",
  },
  {
    title: "İade Hatırlatma",
    message:
      "Merhaba {musteri}, kiraladığınız ürünün iade tarihi yaklaşmıştır. Gecikme yaşanmaması için bilginize sunarız.",
  },
  {
    title: "Kalan Ödeme",
    message:
      "Merhaba {musteri}, kalan ödemeniz bulunmaktadır. Teslim öncesi ödemenizi tamamlamanızı rica ederiz.",
  },
  {
    title: "Randevu Teyit",
    message:
      "Merhaba {musteri}, MAUNA Couture randevunuz başarıyla oluşturulmuştur. Sizi bekliyoruz.",
  },
];
...
export default function SmsPage() {
  ...
  const renderedMessage = message.replaceAll(
    "{musteri}",
    selectedCustomerData?.full_name || "Değerli müşterimiz"
  );
      ...
      <div className="space-y-5 pb-24 lg:pb-0">
        <div className="rounded-[1.8rem] bg-gradient-to-r from-[#211b16] via-[#2b231c] to-[#b69463] p-6 text-white">
          ...
          <p className="mt-2 text-sm text-white/70">
            Hazır şablonlarla müşteri mesajlarını hızlıca oluşturun.
          </p>
        </div>
          ...
          <div className="premium-card p-6">
            ...
            <div className="mt-6 grid gap-3">
              {templates.map((item) => (
                ...
                >
                  <div className="text-sm font-black text-[#211b16]">
                    {item.title}
                  </div>

                  <div className="mt-1 text-xs font-bold leading-5 text-[#8a7f72]">
                    {item.message}
                  </div>
                </button>
              ))}
